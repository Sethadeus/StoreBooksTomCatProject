        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (!fileItem.isFormField()) {
                    ...
                    if (Objects.equals(fileItem.getFieldName(), "id")){
                        auth.setId_author(Integer.valueOf(value));
                    }
                    else if (Objects.equals(fileItem.getFieldName(), "name")){
                        auth.setName_author(value);
                    }
                    else if (Objects.equals(fileItem.getFieldName(), "desc")){
                        auth.setDescription_author(value);
                    }
                    else if (Objects.equals(fileItem.getFieldName(), "path")){
                        if (needPrevPath){
                            auth.setIcon_author_path(value);
                        }
                    }
